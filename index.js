...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:ZS\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5521999742825:+55 47992091566\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '.','!','#'
blocked = []
limitawal = '999999999'
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Olá @${num.split('@')[0]}\nBem vindo ao grupo *${mdata.subject}*\n\nEspero que goste do grupo ❤️   membro novo tem que mama os admin`
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD ZS BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] ZEUS? Este é um recurso especial para o ZEUS ❌',
					ownerB: '[❗] ZEUS? Este é um recurso especial para o ZEUS ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de ZS. Registre-se para fazer amizade com o bot ZS por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar ZS|17\n\n──「 ZS BOT 」──`,
			...
			const ownerNumber = ["5521999742825@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"5521999742825@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["5521999742825@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["5521999742825@s.whatsapp.net"]//ubah nomor lo
			const premium = ["5521999742825@s.whatsapp.net","5511998346168@s.whatsapp.net","5517996188967@s.whatsapp.net"] 
	...
	if (messagesC.includes("fdp")){
		...
		if (messagesC.includes("bot")){
            ...
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
				...
				if (messagesC.includes("ZS")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/ZSf.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
...
// recursos anime, random @ZS domina vida
          ...
          reply('Espere..')
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o ZS ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT ZS ✨* 」\n*│+ wa.me/5521999742825*╰──────*「 *ZS* 」*────*\n\n*_SE QUER SER ADMIN DO BOT ZS_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do ZS:*\n\n https://youtube.com/channel/UCar9KgJS2XuP_p0EQ8ibZEQ'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
