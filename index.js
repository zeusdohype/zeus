		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerG: '[❗] ZS? Este é um recurso especial para o ZS ❌',
					ownerB: '[❗] ZS? Este é um recurso especial para o ZS ❌',
			...
			const premium = ["5521999742825@s.whatsapp.net","558296156440@s.whatsapp.net"] 
